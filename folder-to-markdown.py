...
def main():
    ...
    root = Tk()
    root.title("Folder to markdown")
    root.geometry("700x350")
    style = Style(theme='flatly')  # Usando el tema "flatly"
    ...
    tite_label = ttk.Label(root, text="Folder to Markdown", font=custom_font, anchor='center')
    tite_label.pack( pady=20)
